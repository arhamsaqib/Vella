        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="flex-direction: column; background-color: #9b7c91 ">
             <h4 style="color: whitesmoke">VELLA CONSULTING INC.</h4>
                <div class="container" style="margin: 15px; border-bottom-style: solid; border-width: 2px; border-color: #d5bdab" >
                    <ul class="navbar-nav">
                        <a class="nav-link" href="#"><h6 style="color: whitesmoke; font-size: 14px">Home</h6></a>
                    </ul>
                </div>
             <div class="container" style="margin-top: 15px; border-bottom-style: solid; border-width: 2px; border-color: #d5bdab">
                <ul class="navbar-nav" style="flex-direction: column">
                  <li class="nav-item">
                    <a class="nav-link" href="#"><h6 style="color: whitesmoke; font-size: 14px">Book Now</h6></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#"><h6 style="color: whitesmoke; font-size: 14px">Appointments</h6></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#"><h6 style="color: whitesmoke; font-size: 14px">Calender</h6></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#"><h6 style="color: whitesmoke; font-size: 14px">Settings</h6></a>
                  </li>
                </ul>
             </div>
             <div class="container" style="margin: 15px; border-bottom-style: solid; border-width: 2px; border-color: #d5bdab" >
